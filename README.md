...
- Probe requests reject duplicate recent turn ids before prompt construction.
...
- Competency models reject duplicate dimension names before probe, scoring, or report matching.
